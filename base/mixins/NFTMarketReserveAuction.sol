  ...
  NFTMarketAuction
{
  ...
  function finalizeReserveAuction(uint256 auctionId) public nonReentrant {
    ...
    (uint256 marketFee, uint256 creatorFee, uint256 ownerRev) =
      _distributeFunds(auction.nftContract, auction.tokenId, auction.seller, auction.amount);

    emit ReserveAuctionFinalized(auctionId, auction.seller, auction.bidder, marketFee, creatorFee, ownerRev);
  }
   ...
   */
  function adminCancelReserveAuction(uint256 auctionId, string memory reason) public onlyMarketAdmin {
